...
public final class Pipe {
  ...
  public interface CommandMessageOrBuilder extends
    ...
    /**
     * <code>optional .Duty duty = 2;</code>
     *
     * <pre>
    ...
    /**
     * <code>optional .StatusOfLeader leaderStatus = 5;</code>
     */
    boolean hasLeaderStatus();
    /**
     * <code>optional .StatusOfLeader leaderStatus = 5;</code>
     */
    pipe.leaderelection.Leaderelection.StatusOfLeader getLeaderStatus();
    /**
     * <code>optional .StatusOfLeader leaderStatus = 5;</code>
     */
    pipe.leaderelection.Leaderelection.StatusOfLeaderOrBuilder getLeaderStatusOrBuilder();
  ...
  public static final class CommandMessage extends
    ...
    public static final int LEADERSTATUS_FIELD_NUMBER = 5;
    /**
     * <code>optional .StatusOfLeader leaderStatus = 5;</code>
     */
     ...
     * <code>optional .StatusOfLeader leaderStatus = 5;</code>
     */
    public pipe.leaderelection.Leaderelection.StatusOfLeader getLeaderStatus() {
      if (payloadCase_ == 5) {
     ...
     * <code>optional .StatusOfLeader leaderStatus = 5;</code>
     */
    public pipe.leaderelection.Leaderelection.StatusOfLeaderOrBuilder getLeaderStatusOrBuilder() {
      if (payloadCase_ == 5) {
         return (pipe.leaderelection.Leaderelection.StatusOfLeader) payload_;
      }
      return pipe.leaderelection.Leaderelection.StatusOfLeader.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (payloadCase_ == 2) {
        output.writeMessage(2, (pipe.common.Common.Duty) payload_);
      }
      if (payloadCase_ == 3) {
        output.writeBool(
      ...
      if (payloadCase_ == 5) {
        output.writeMessage(5, (pipe.leaderelection.Leaderelection.StatusOfLeader) payload_);
      }
      if (payloadCase_ == 6) {
    ...
    public int getSerializedSize() {
      ...
      if (payloadCase_ == 2) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, (pipe.common.Common.Duty) payload_);
      }
      if (payloadCase_ == 3) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(
      ...
      if (payloadCase_ == 5) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, (pipe.leaderelection.Leaderelection.StatusOfLeader) payload_);
      }
      if (payloadCase_ == 6) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
       ...
       */
      public pipe.common.Common.DutyOrBuilder getDutyOrBuilder() {
        if ((payloadCase_ == 2) && (dutyBuilder_ != null)) {
  ...
  payloadCase_ = 4;
      ...
      private com.google.protobuf.SingleFieldBuilder<
          pipe.leaderelection.Leaderelection.StatusOfLeader, pipe.leaderelection.Leaderelection.StatusOfLeader.Builder, pipe.leaderelection.Leaderelection.StatusOfLeaderOrBuilder> leaderStatusBuilder_;
      /**
       * <code>optional .StatusOfLeader leaderStatus = 5;</code>
       */
      public boolean hasLeaderStatus() {
       ...
       * <code>optional .StatusOfLeader leaderStatus = 5;</code>
       */
      public Builder setLeaderStatus(pipe.leaderelection.Leaderelection.StatusOfLeader value) {
        if (leaderStatusBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>optional .StatusOfLeader leaderStatus = 5;</code>
       */
      public Builder mergeLeaderStatus(pipe.leaderelection.Leaderelection.StatusOfLeader value) {
        if (leaderStatusBuilder_ == null) {
          if (payloadCase_ == 5 &&
       ...
       * <code>optional .StatusOfLeader leaderStatus = 5;</code>
       */
      public pipe.leaderelection.Leaderelection.StatusOfLeader.Builder getLeaderStatusBuilder() {
       ...
       */
      public pipe.leaderelection.Leaderelection.StatusOfLeaderOrBuilder getLeaderStatusOrBuilder() {
        if ((payloadCase_ == 5) && (leaderStatusBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\npipe.proto\032\014common.proto\032\024leaderelecti" +
      "on.proto\"\260\001\n\016CommandMessage\022\027\n\006header\030\001 " +
      "\002(\0132\007.Header\022\025\n\004duty\030\002 \001(\0132\005.DutyH\000\022\016\n\004p" +
      "ing\030\003 \001(\010H\000\022\021\n\007message\030\004 \001(\tH\000\022\'\n\014leader" +
      "Status\030\005 \001(\0132\017.StatusOfLeaderH\000\022\027\n\003err\030\006" +
    ...
    internal_static_CommandMessage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_CommandMessage_descriptor,
        new java.lang.String[] { "Header", "Duty", "Ping", "Message", "LeaderStatus", "Err", "Payload", });
    pipe.common.Common.getDescriptor();
    pipe.leaderelection.Leaderelection.getDescriptor();
  }
