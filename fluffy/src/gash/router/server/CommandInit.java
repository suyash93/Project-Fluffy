...
import gash.router.server.handler.CommandHandler;
...
public class CommandInit extends ChannelInitializer<SocketChannel> {
	...
	public CommandInit(MessageServer server, boolean enableCompression) {
		super();
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("handler", new CommandHandler(server));
	}
}
